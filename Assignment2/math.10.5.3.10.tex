...
\begin{enumerate} [label=(\roman*)]
   ...
   $\because$ Given equation has common difference between any two consecutive terms is $4$ i.e. independent of '$n$'\\
    ...
    \begin{align}
        ...
        X(z) &= \sum_{n = -\infty}^{\infty}[3 + 4n].u(n) \, z^{-n} \\
        nu(n) &\system{Z} -z.U'(z)\\
        X(z) &= \frac{3}{1-z^{-1}} + \frac{4.z^{-1}}{(1-z^{-1})^2} ; |z|>1\\
        \because y(n) &= x(n) * u(n)\\
        Y(z) &= X(z)U(z)\\
        Y(z) &= \sbrak{\frac{3}{1-z^{-1}} + \frac{4 z^{-1}}{\left(1-z^{-1}\right)^2} }.\frac{1}{1-z^{-1}}
    \end{align}
   ...
   \end{center}
    ...
    \begin{align}
         X(z) &= \sum_{n = -\infty}^{\infty} x(n) z^{-n} \label{eq:z-transform}\\
         X(z) &= \sum_{n = -\infty}^{\infty}[9 - 5n].u(n) \, z^{-n} \\
        nu(n) &\system{Z} -z.U'(z)\\
         X(z) &= \frac{9}{1-z^{-1}} - \frac{5.z^{-1}}{(1-z^{-1})^2} ; |z|>1\\
        \because y(n) &= x(n) * u(n)\\
        Y(z) &= X(z)U(z)\\
         Y(z) &= \sbrak{\frac{9}{1-z^{-1}} - \frac{5 z^{-1}}{\brak{1-z^{-1}}^2} }.\frac{1}{1-z^{-1}}
    \end{align}
    Using contour integeration for inverse Z transformation,\\
    \begin{align}
        y(14) &= \frac{1}{2\pi j}\int Y(z) z^{13} dz \\
